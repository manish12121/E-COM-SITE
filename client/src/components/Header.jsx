            ...
            <>
                ...
                <ul
                    className={`absolute ${isProfileMenuOpen ? 'block' : 'hidden'
                        } bg-gray-700 p-2 mt-2 space-y-2 text-white border rounded-md`}
                >
                    <li>
                        <Link to="/profile">
                            <FiUser className="mr-1" />
        ...
        <nav className="bg-blue-400 p-4">
            <div className="flex items-center justify-between">
                <div className="flex items-center">
                    ...
                    <input
                        type="text"
                        placeholder="Search"
                        className="ml-4 p-2 rounded-md bg-gray-100 text-gray hidden sm:block"
                        value={keyword}
                        onChange={e => setKeyword(e.target.value)}
                    />
                    <button className="bg-gray-700 text-white py-2 px-4 rounded-md hidden sm:block ml-2"
            ...
            {isMobileMenuOpen && (
                <div className="mt-4 sm:hidden">
                    ...
                    />
                    <button className="bg-gray-600500 text-white py-2 px-4 rounded-md w-full mb-2">
                        Search
                    </button>
